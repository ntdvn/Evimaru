...
class ManagerCoSoDaoTaoKhoaHocAddClass extends Component {
    constructor(props){
        super(props);
        this.state = {
            tenLop: "",
    ...
    render() {
        ...
        var listCauHoi, listBuoiHoc, listGiangVien, lopHoc, dataGiangViens, data, table;
        if(!JSONisEmpty(khoaHoc)){
            var backLinkArr = [
                ...
                {
                    name: "Thêm lớp học",
                    link: `/user/manager/nhomkhoahoc/${nhomKhoaHoc._id}/khoahoc/${khoaHoc._id}/information/class/add`,
                },
            ]
            ...
            if(coSoDaoTao.hasOwnProperty('danhSachGiangVien')){
                dataGiangViens = coSoDaoTao.danhSachGiangVien.giangVien.map((giangVien, i) => {
                ...
                data = {
                    columns: [
                        ...
                        {
                            label: "Phụ trách lớp này",
                            field: "phuTrachLopNay",
                            width: 5
                        },
                    ],
                    rows: dataGiangViens
            ...
            return (
                <div>
                    ...
                    <div className="row mb-3">
                        ...
                        <div className="col-md-12">
                            <h3>Chọn giảng viên phụ trách lớp: </h3>
                    ...
                    { errorPanel }
                    <Button color="primary" onClick={this.handlerPostLopHoc.bind(this, khoaHoc._id)}>Thêm lớp học</Button>
                    {errors.message && (
                        <div className="alert alert-danger" role="alert">
                            {errors.message}
                        </div>
...
export default withRouter(ManagerCoSoDaoTaoKhoaHocAddClass);
